{{-- Full-page terminal.
     ...
     The terminal itself is served by the gateway and embedded in an iframe, so
     xterm.js never has to be published into LibreNMS's html/ tree. The ticket
     is handed over by postMessage rather than in the iframe URL: a query string
     is written to the proxy access log and leaks through Referer, and the
